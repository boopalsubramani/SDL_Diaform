...
//     // Construct the array of invoice details for "With invoice"
...
//         />
//         {canGoBack && (
//           <TouchableOpacity onPress={() => navigation.navigate('Payments')} style={{ position: 'absolute', top: 20, left: 20,zIndex:1 }}>
//             <ButtonBack />
//           </TouchableOpacity>
//         )}
//       </SafeAreaView>
...
const PaymentScreen = () => {
  ...
  const handleWebViewNavigationStateChange = (newNavState: any) => {
    ...
    console.log("Navigation State Change:", { url, canGoBack });
    ...
    if (url.includes('payment/success') || url.includes('a.aspx')) {
      ...
      console.log("Payment Exit/Cancel URL detected");
      // navigation.navigate('PaymentCancelled');
      // Restore the previous tab state
      console.log("Navigating back, restoring tab:", previousTab);
      if (previousTab) {
        setSelectedOption(previousTab);
        setPreviousTab(null);
      }
    }
  };
  ...
  const handlePayment = async () => {
    ...
    console.log("Storing current tab:", selectedOption);
    setPreviousTab(selectedOption);
  ...
  if (paymentUrl) {
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        />
        {canGoBack && (
          <TouchableOpacity onPress={() => navigation.navigate('Calender')} style={{ position: 'absolute', bottom: 10, left: 10 }}>
            <ButtonBack />
          </TouchableOpacity>
        )}
      </SafeAreaView>
