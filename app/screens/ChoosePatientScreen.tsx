...
const ChoosePatientScreen = ({ showHeader = true, route, }: any) => {
    ...
    const handlePhysicianSearch = (queryPhysician: string, type: string) => {
        ...
        if (queryPhysician) {
            ...
            setFilteredPhysician([]);
            setSelectedPhysicianDetails(null); // Clear physician details
        }
    };
                        ...
                        <View style={styles.row}>
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput
                                    ...
                                    value={codeQuery}
                                    onChangeText={(query) => {
                                        handlePatientSearch(query, 'code');
                                        if (query === '') {
                                            setFilteredPatients([]);
                                            setSelectedPatientDetails(null); // Clear patient details
                                        }
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput
                                    ...
                                    value={nameQuery}
                                    onChangeText={(query) => {
                                        handlePatientSearch(query, 'name');
                                        if (query === '') {
                                            setFilteredPatients([]);
                                            setSelectedPatientDetails(null); // Clear patient details
                                        }
                            ...
                            <TextInput
                                ...
                                onChangeText={(query) => {
                                    if (query === '') {
                                        ...
                                        handlePhysicianSearch(query, 'name');
                                    }
                                }}
                            />
                        </View>
